...
function ReadMorePagethree(){
    return(
      ...
      <div>
          <h1 className='readhead3'>6 Mechanical Engineering Webinars and Workshops That You Should Know</h1>
          ...
          <img src='https://www.guvi.in/blog/wp-content/uploads/2023/09/Feature-image-Mechanical-Engineering-Webinars-and-Workshops-That-You-Should-Know.webp'/>
          </div>
          <div>
             <p>In the constantly growing landscape of artificial intelligence (AI) and natural language processing (NLP), ChatGPT has emerged as a significant milestone. ChatGPT is an advanced language model, developed by OpenAI, represents a leap forward for humankind, in our ability to interact with machines using natural language.
              <br></br>
              <br></br>

This revolutionary language model developed by Open AI, an American AI research and deployment company has captured the minds of tech enthusiasts, students, teachers, businesses, researchers, and everyone. But, does it impact your career? What are its applications? does it enhance your quality of work? Why does it even matter?</p>
          </div>
...
export default ReadMorePagethree