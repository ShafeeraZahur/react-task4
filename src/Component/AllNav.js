        ...
        <div className='container'>
            <Card sx={{ maxWidth: 345 }} className='card-container'>
                ...
                <CardContent>
                    ...
                    In today’s tech world, making sure software works perfectly is super important. That’s where automation<br></br>
                    </Typography>
                    <CardActions>
            ...
            <Card sx={{ maxWidth: 345 }} className='card-container'>
                ...
                <CardContent>
                    <Typography gutterBottom variant="h5" color="text.primary">
                    Top 7 Cloud Computing Tools of 2023
            ...
            <Card sx={{ maxWidth: 345 }} className='card-container'>
                ...
                <CardContent>
                    <Typography gutterBottom variant="h5" color="text.primary">
                    Essential Cloud Computing Skills for Cloud Engineers in 2023
                    </Typography>
            ...
            <Card sx={{ maxWidth: 345 }} className='card-container'>
                <CardMedia
                    component="img"
                    height="194"
                    image="https://www.guvi.in/blog/wp-content/uploads/2023/09/feature-image-Strategies-for-Effective-Tech-Talent-Sourcing.webp"
                    alt="Paella dish"
                    onClick={()=>navigate("/readmorepagefour")}
                />
                <CardContent>
                    <Typography gutterBottom variant="h5" color="text.primary">
                    Top 8 Strategies for Effective Tech Talent Sourcing
                    </Typography>
            ...
            <Card sx={{ maxWidth: 345 }} className='card-container'>
                <CardMedia
                    component="img"
                    height="194"
                    image='https://www.guvi.in/blog/wp-content/uploads/2023/09/feature-image-How-to-Hire-a-Full-Stack-Developer.webp'
                    alt="Paella dish"
            ...
            <Card sx={{ maxWidth: 345 }} className='card-container'>
                <CardMedia
                    component="img"
                    height="194"
                    image='https://www.guvi.in/blog/wp-content/uploads/2023/09/Feature-image-Cloud-Computing-Syllabus-for-a-Cloud-Engineer.webp'
                    alt="Paella dish"
            ...
            <Card sx={{ maxWidth: 345 }} className='card-container'>
                <CardMedia
                    component="img"
                    height="194"
                    image='https://www.guvi.in/blog/wp-content/uploads/2023/09/Feature-image-Best-Career-Opportunities-in-Cloud-Computing-Engineering.webp'
                    alt="Paella dish"
                    onClick={()=>navigate("/readmorepageeight")}
                />
                <CardContent>
                    <Typography gutterBottom variant="h5" color="text.primary">
                    6 Best Career Opportunities in Cloud Computing Engineering
                    </Typography>
